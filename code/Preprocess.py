...
if __name__ == '__main__':
    params = {
        'SRC_PATH': '/content/VideoClassification/Data',        # Path of downloaded videos
        'DST_PATH': '/content/VideoClassification/VideosResized224'       # Path where you wish to generate the videos
    }
    p = Preprocess(params)
    p.resize((224, 224), 60)         # Resized video and number of frames in each video clip
